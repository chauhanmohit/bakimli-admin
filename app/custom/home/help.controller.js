(function() {
    ...
    angular.module('bakimliHome').controller('HelpController',[
        '$timeout', '$rootScope', '$scope', 'helpPosts', 'variables', helpCtrl
        ]);

    function helpCtrl($timeout, $rootScope, $scope, helpPosts, variables) {
        $rootScope.page_full_height = true;
        $rootScope.headerDoubleHeightActive = true;

        $scope.help_data = helpPosts;
